...
#ifndef PROTOBUF_C_iwaserver_2eproto__INCLUDED
#define PROTOBUF_C_iwaserver_2eproto__INCLUDED
...
typedef enum _IWAserverAuth__LogRegServer__ResultCode {
  I_WASERVER_AUTH__LOG_REG_SERVER__RESULT_CODE__OK = 0
} IWAserverAuth__LogRegServer__ResultCode;
typedef enum _IWAserverAuth__ProofServer__ResultCode {
  I_WASERVER_AUTH__PROOF_SERVER__RESULT_CODE__OK = 0
...
{
  ProtobufCMessage base;
  IWAserverAuth__LogRegServer__ResultCode result;
...
{
  ProtobufCMessage base;
  IWAserverAuth__ProofServer__ResultCode result;
  protobuf_c_boolean has_m2;
  ProtobufCBinaryData m2;
};
...
extern const ProtobufCEnumDescriptor    i_waserver_auth__log_reg_server__result_code__descriptor;
...
extern const ProtobufCEnumDescriptor    i_waserver_auth__proof_server__result_code__descriptor;
...
#endif  /* PROTOBUF_iwaserver_2eproto__INCLUDED */
